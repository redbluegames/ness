...
namespace GoogleFu
{
	...
	{
		public enum rowIds {
			SWORD_WEAK, SWORD_STRONG, ENEMY_WEAK, ENEMY_STRONG, PLAYER_BLOCKING_WEAK, PLAYER_BLOCKING_STRONG, SPEAR_JAB, SPEAR_HOLD, BOW_QUICKFIRE, BOW_AIMEDSHOT, ENEMY_FIREBALL, GIANT_SWING, GIANT_BIGSWING
		};
